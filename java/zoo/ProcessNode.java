...
public class ProcessNode implements Runnable{
  ...
  private static final String LEADER_ELECTION_ROOT_NODE = "/elections";
  private static final String PROCESS_NODE_PREFIX = "/p";
  ...
  public ProcessNode(int id,String zkURL) throws IOException {
    this.id = id;
